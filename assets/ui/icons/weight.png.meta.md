...
vector-source: assets/ui/icons/weight.svg
runtime-export: assets/ui/icons/weight.png
license: project-internal
status: placeholder
width: 48
height: 48
palette: ui/default
description: First-pass vector UI icon for weight.
...
replacement: pending final art review for assets/ui/icons/weight.png
