...
vector-source: assets/ui/icons/coin.svg
runtime-export: assets/ui/icons/coin.png
license: project-internal
status: placeholder
width: 48
height: 48
palette: ui/default
description: First-pass vector UI icon for coin.
...
replacement: pending final art review for assets/ui/icons/coin.png
