...
vector-source: assets/ui/icons/memory_core.svg
runtime-export: assets/ui/icons/memory_core.png
license: project-internal
status: placeholder
width: 48
height: 48
palette: ui/default
description: First-pass vector UI icon for memory_core.
...
replacement: pending final art review for assets/ui/icons/memory_core.png
