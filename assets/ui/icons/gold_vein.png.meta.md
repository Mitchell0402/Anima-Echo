...
vector-source: assets/ui/icons/gold_vein.svg
runtime-export: assets/ui/icons/gold_vein.png
license: project-internal
status: placeholder
width: 48
height: 48
palette: ui/default
description: First-pass vector UI icon for gold_vein.
...
replacement: pending final art review for assets/ui/icons/gold_vein.png
