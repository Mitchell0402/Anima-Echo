...
vector-source: assets/ui/icons/health.svg
runtime-export: assets/ui/icons/health.png
license: project-internal
status: placeholder
width: 48
height: 48
palette: ui/default
description: First-pass vector UI icon for health.
...
replacement: pending final art review for assets/ui/icons/health.png
