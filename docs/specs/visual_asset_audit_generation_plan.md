...
- HUD icons and code-colored bars: health, oxygen, weight, stability, morality, day/night, coin.
...
| `icon_morality_good` | `assets/ui/icons/morality_good.png` | 32x32 | Gifted/star-good tracker |
| `icon_morality_bad` | `assets/ui/icons/morality_bad.png` | 32x32 | Sold/star-bad tracker |
...
| `equipment_talisman_good` | `assets/ui/icons/equipment/talisman_good.png` | 48x48 | Good path equipment |
| `equipment_talisman_evil` | `assets/ui/icons/equipment/talisman_evil.png` | 48x48 | Evil path equipment |
...
| Asset id | Target path | Size | Used by |
|----------|-------------|------|---------|
| `mine_tileset_shallow` | `assets/mine/tiles/shallow_cave_tileset.png` | 512x512 atlas | `test_scene.tscn` TileMap |
...
### Batch 9: Characters And Enemies

Target folders:

- `assets/characters/player/`
- `assets/enemies/gnoll/`

Current player and gnoll frames may be kept after sidecar review, but if the style does not match the new imagegen town/UI direction, regenerate these as sprite sheets.

| Asset id | Target path | Size | Notes |
|----------|-------------|------|-------|
| `player_idle_sheet` | `assets/characters/player/player_idle.png` | 256x64 | 4 frames |
| `player_walk_sheet` | `assets/characters/player/player_walk.png` | 256x64 | 4 frames |
| `player_run_sheet` | `assets/characters/player/player_run.png` | 256x64 | 4 frames |
| `player_attack_sheet` | `assets/characters/player/player_attack.png` | 256x64 | 4 frames |
| `player_hurt` | `assets/characters/player/player_hurt.png` | 64x64 | Single frame |
| `player_death_sheet` | `assets/characters/player/player_death.png` | 256x64 | 4 frames |
| `gnoll_idle_sheet` | `assets/enemies/gnoll/gnoll_idle.png` | 256x64 | 4 frames |
| `gnoll_walk_sheet` | `assets/enemies/gnoll/gnoll_walk.png` | 256x64 | 4 frames |
| `gnoll_run_sheet` | `assets/enemies/gnoll/gnoll_run.png` | 256x64 | 4 frames |
| `gnoll_attack_sheet` | `assets/enemies/gnoll/gnoll_attack.png` | 256x64 | 4 frames |
| `gnoll_hurt` | `assets/enemies/gnoll/gnoll_hurt.png` | 64x64 | Single frame |
| `gnoll_death_sheet` | `assets/enemies/gnoll/gnoll_death.png` | 256x64 | 4 frames |

### Batch 10: Title, Intro, And End-State Screens
...
| `screen_good_ending` | `assets/ui/screens/good_ending.png` | 1280x720 | Planned ending screen |
| `screen_bad_ending` | `assets/ui/screens/bad_ending.png` | 1280x720 | Planned ending screen |
| `screen_neutral_ending` | `assets/ui/screens/neutral_ending.png` | 1280x720 | Planned ending screen |
| `screen_statistics_panel` | `assets/ui/screens/statistics_panel.png` | 720x520 | Planned end statistics |
...
1. Create missing folders under `assets/ui`, `assets/town`, `assets/mine`, `assets/characters`, and `assets/enemies`.
